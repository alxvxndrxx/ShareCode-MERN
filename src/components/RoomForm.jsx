...
const RoomForm = () => {
  ...
  return (
    <div className="px-8 py-4 rounded-md flex flex-col space-y-4 bg-gray-900 text-white w-10/12 md:w-1/2 lg:w-1/3 transition-all duration-200">
      <div
      ...
      <p className="text-white">Paste room id below:</p>
      <div className="flex flex-col space-y-4 w-full">
        <input
          type="text"
          placeholder="Room Id"
          name="roomId"
          className="px-3 md:px-6 py-2 rounded-md shadow-sm font-josefin text-black hover:outline-none hover:ring-2 ring-green-300 active:outline-none active:ring-2 focus:outline-none focus:ring-2 text-md md:text-lg bg-gray-800 text-white"
          value={roomID}
          onChange={(event) => {
